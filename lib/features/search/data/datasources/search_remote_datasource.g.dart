...
class _SearchRemoteDatasource implements SearchRemoteDatasource {
  ...
  Future<SearchResponseDto> search({
    ...
    final queryParameters = <String, dynamic>{r'q': query, r'types': types};
  ...
  Future<ScopedCentersResponseDto> searchCenters({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<ScopedCentersResponseDto>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/search/centers',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late ScopedCentersResponseDto _value;
    try {
      _value = ScopedCentersResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
