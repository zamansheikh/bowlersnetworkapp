...
part of 'media_remote_datasource.dart';
...
class _MediaRemoteDatasource implements MediaRemoteDatasource {
  ...
  @override
  Future<VideosPageDto> getGlobalVideos({int? page, int? pageSize}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'page': page,
      r'page_size': pageSize,
  ...
  @override
  Future<SplitsPageDto> getGlobalSplits({int? page, int? pageSize}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'page': page,
      r'page_size': pageSize,
