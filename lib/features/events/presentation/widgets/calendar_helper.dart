...
class CalendarHelper {
  static List<CalendarDay> generateCalendar(DateTime currentDate, List<CalendarEvent> events) {
    ...
    final firstDayOfWeek = firstDayOfMonth.weekday % 7; // Convert Monday=1 to Sunday=0
